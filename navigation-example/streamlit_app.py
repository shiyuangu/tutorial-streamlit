# Cf: https://docs.streamlit.io/develop/tutorials/multipage/dynamic-navigation
...
def login():
    ...
    if st.button("Log in"):
        # sgu: when the button is clicked, the script runs from the top first and then enter this function
        print("sgu login_button clicked")
...
#since you're calling this command in your entrypoint file, you won't need to also call it within each page.
